...
To run a specific release (such as `1.1.1`), pin the version by appending `@1.1.1` to the Git URL:
```bash
uvx --from git+https://github.com/karlrobeck/mt5-grpc@1.1.1 mt5-grpc serve --host 127.0.0.1 --port 8080 --max-workers 10
```
